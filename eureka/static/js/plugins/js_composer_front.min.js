...
function($) {
    ...
    "function" != typeof window.vc_googleplus && (window.vc_googleplus = function() {
        var po, s;
        0 < jQuery(".wpb_googleplus").length && ((po = document.createElement("script")).type = "text/javascript",
        po.async = !0,
        po.src = "https://apis.google.com/js/plusone.js",
        (s = document.getElementsByTagName("script")[0]).parentNode.insertBefore(po, s))
    }
    ),
    "function" != typeof window.vc_pinterest && (window.vc_pinterest = function() {
        var po, s;
        0 < jQuery(".wpb_pinterest").length && ((po = document.createElement("script")).type = "text/javascript",
        po.async = !0,
    ...
    "function" != typeof window.vc_ttaToggleBehaviour && (window.vc_ttaToggleBehaviour = function($el) {
        function event() {
            ...
            toggle.parent().parent().parent().find(".vc_pagination-item").each(function() {
                if (!$(this).hasClass("vc_active"))
                    return $(this).find("a").click(),
                    !1
            })
        }
        ($el ? $el.find(".wpb-tta-toggle") : jQuery(".wpb-tta-toggle")).off("click").on("click", event),
        setTimeout(function() {
    ...
    "function" != typeof window.vc_tabsBehaviour && (window.vc_tabsBehaviour = function($tab) {
        var ver, old_version;
        jQuery.ui && ($tab = $tab || jQuery(".wpb_tabs, .wpb_tour"),
        ...
        $tab.each(function(index) {
            ...
            jQuery(this).find(".wpb_prev_slide a, .wpb_next_slide a").on("click", function(e) {
                ...
                index = jQuery(this).parent().hasClass("wpb_next_slide") ? e <= index + 1 ? 0 : index + 1 : index - 1 < 0 ? e - 1 : index - 1,
    ...
    "function" != typeof window.vc_carouselBehaviour && (window.vc_carouselBehaviour = function($parent) {
        ($parent ? $parent.find(".wpb_carousel") : jQuery(".wpb_carousel")).each(function() {
            var $this = jQuery(this);
            !0 !== $this.data("carousel_enabled") && $this.is(":visible") && ($this.data("carousel_enabled", !0),
    ...
    "function" != typeof window.vc_rowBehaviour && (window.vc_rowBehaviour = function() {
        ...
        function fullWidthRow() {
            var $elements;
            void 0 !== window.wpb_disable_full_width_row_js && window.wpb_disable_full_width_row_js || ($elements = $('[data-vc-full-width="true"]'),
            $.each($elements, function(key, item) {
                var el_margin_left, el_margin_right, offset, width, cssProps, padding, paddingRight, $el = $(this), $el_full = ($el.addClass("vc_hidden"),
                $el.next(".vc_row-full-width"));
                ($el_full = $el_full.length ? $el_full : $el.parent().next(".vc_row-full-width")).length && (el_margin_left = parseInt($el.css("margin-left"), 10),
        ...
        if (window.vcParallaxSkroll && window.vcParallaxSkroll.destroy(),
    ...
    "function" != typeof window.wpb_prepare_tab_content && (window.wpb_prepare_tab_content = function(event, ui) {
        ...
        $pie_charts.length && !$pie_charts.is(".map_ready") && (($round_charts = $pie_charts.find("iframe")).attr("src", $round_charts.attr("src")),
    ...
    "function" != typeof window.vc_initVideoBackgrounds && (window.vc_initVideoBackgrounds = function() {
        jQuery("[data-vc-video-bg]").each(function() {
            ...
            (youtubeUrl = vcExtractYoutubeId(youtubeUrl)) && ($element.find(".vc_video-bg").remove(),
    ...
    "function" != typeof window.vc_setHoverBoxHeight && (window.vc_setHoverBoxHeight = function(hoverBox) {
        hoverBox.each(function() {
            var $this = jQuery(this)
              ...
              , frontHeight = (hoverBoxInner.css("min-height", 0),
