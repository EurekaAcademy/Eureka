...
*/
    ...
    function W(a, b, c, d) {
        ...
        if (2 == d)
            if (La(T(c, 0)))
                a = T(c, 1),
                La(a) && (e = e.concat(0 == w(a, 9) ? t(p(c, 1), 9) : t(a, 9)),
                e.sort(),
    ...
    function Pa(a, b, c, d, f, e) {
        ...
        if (0 == h.length)
            ...
            if (0 == g.search(h)) {
                ...
                l && null != l[1] && 0 < l[1].length && "0" == N(l[1], va) ? g = !1 : (b.i = "",
                b.g(g.substring(h)),
                g = !0)
            } else
                g = !1;
        ...
        h = "" + g,
        l = b.toString(),
        0 == l.lastIndexOf(h, 0) && (h = new C(l.substring(h.length)),
        l = p(c, 1),
        l = new RegExp(v(l, 2)),
        Qa(h, c, null),
        h = h.toString(),
    ...
    function Ra(a, b, c, d) {
        ...
        var h = e;
        null == h ? g = !0 : 0 === h.length ? g = !1 : (g = Ca.exec(h),
        h = Da.exec(h),
        g = null !== g || null !== h);
        if (!g)
            throw Error("The string supplied did not seem to be a phone number");
