    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobs', wagtail.fields.StreamField([('introduction', wagtail.blocks.RichTextBlock(required=False)), ('job', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(required=False)), ('description', wagtail.blocks.RichTextBlock(required=False)), ('location', wagtail.blocks.CharBlock(required=False))])), ('more_text', wagtail.blocks.RichTextBlock(required=False))], blank=True, null=True)),
                ('career_services', wagtail.fields.RichTextField(blank=True, null=True)),
                ('testimonials', wagtail.fields.StreamField([('intro', wagtail.blocks.RichTextBlock(required=False)), ('person', wagtail.blocks.StructBlock([('message', wagtail.blocks.RichTextBlock(required=False)), ('first_name', wagtail.blocks.CharBlock(required=False)), ('last_name', wagtail.blocks.CharBlock(required=False)), ('personal_info', wagtail.blocks.CharBlock(required=False))])), ('paragraph', wagtail.blocks.RichTextBlock(required=False))], blank=True, null=True)),
                ('faq', wagtail.fields.StreamField([('new_faq', wagtail.blocks.StructBlock([('question', wagtail.blocks.CharBlock(required=False)), ('answer', wagtail.blocks.RichTextBlock(required=False))]))], blank=True, null=True)),
